...
- [ ] 2.4 Implement fallback ingestion when RAG returns no matches:
  - [ ] 2.4.1 Discover relevant recent filings (within ~6 months).
  - [ ] 2.4.2 Fetch filing content and chunk/embed for ChromaDB.
  - [ ] 2.4.3 Upsert to the appropriate ChromaDB collection.
  - [ ] 2.4.4 Rerun retrieval and return top 5.
- [ ] 2.5 Merge outputs into a single structured response with stable keys.
